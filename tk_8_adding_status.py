...
def forward(image_number):
    ...
    status = Label(root, text = "Image "+ str(image_number + 1) +" of " + str(len(images_list)), bd = 1, relief= SUNKEN, anchor = E)
...
status.grid(row = 2, column = 0, columnspan = 3, sticky= W+E) # sticky - nagigation West/East
